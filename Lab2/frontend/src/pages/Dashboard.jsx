    ...
    <div style={{ paddingBottom: 80 }}>
      ...
      >
        ...
        <motion.div variants={item} className="bento-card" style={{ gridColumn: 'span 7', gridRow: 'span 2', background: 'linear-gradient(135deg, rgba(20,20,24,0.8) 0%, rgba(10,10,12,0.9) 100%)', backdropFilter: 'blur(20px)' }}>
          ...
          <div style={{ marginTop: 40, display: 'flex', gap: isMobile ? 24 : 60, flexWrap: 'wrap' }}>
            <div>
      ...
      <motion.div 
        ...
        style={{ marginTop: 20, padding: isMobile ? '24px 20px' : '40px 48px', minHeight: isMobile ? 300 : 400 }}
      >
        ...
        <div style={{ height: isMobile ? 200 : 300, width: '100%', marginLeft: -20 }}>
          <ResponsiveContainer>
